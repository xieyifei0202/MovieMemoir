...
public class ShareMovieAdapter extends RecyclerView.Adapter<ShareMovieAdapter.HomeMovieHolder> {
    ...
    public ShareMovieAdapter(Context mContext) {
    ...
    public void onBindViewHolder(@NonNull HomeMovieHolder holder, int position) {
        ...
        holder.tv_g.setVisibility(View.VISIBLE);
        ...
        holder.tv_g.setOnClickListener(view -> {
            if (iOnClickAdd != null) {
                iOnClickAdd.iOnClickAddGallery(mList.get(position).getTitle() + "");
            }
        });
    ...
    public interface IOnClickAdd {
        ...
        void iOnClickAddGallery(String title);
